    ...
    <div className={styles.content}>
      <div className={styles.top}>
        ...
        <div className={styles.media-icons}>
          <a href="/"><i className="fab fa-facebook-f" to="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css"></i></a>
          ...
          <a href="/"><i className="fab fa-linkedin-in" to="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css"></i></a>
